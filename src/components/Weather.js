                    ...
                    (weather || []).map((wer, index) => {
                        return (
                            <section className="vh-0">
                                ...
                                <div style={{backgroundColor: props.mode ==='light'?'red':'black'}} className={`container2`}>
                                    <div className="background ">
                                        <div style={{backgroundColor: props.mode ==='light'?'rgba(253,184,19,1)':'black'}} className={`Circle1 w-90 h-90`}></div>
                                        <div style={{backgroundColor: props.mode ==='light'?'rgba(246,140,31,0.7)':'black'}} className="Circle2 w-90 h-90"></div>
                                        <div style={{backgroundColor: props.mode ==='light'?'rgba(241,125,45,0.7)':'black'}} className="Circle3 w-90 h-90"></div>
                                        <div className="content">
                                            <h1 className="Condition"><i className="fs-1 material-icons sun">wb_sunny</i> {wer.current.condition.text}</h1>
